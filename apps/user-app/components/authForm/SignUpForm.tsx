...
const SignUpForm = () => {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-4 p-4 w-full mx-auto">
        ...
        <button type="submit" className="bg-blue-600 rounded p-2 text-white cursor-pointer hover:bg-blue-500">Sign Up</button>
      </form>
