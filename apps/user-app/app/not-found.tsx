...
const NotFound = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8 font-inter"> {/* Added font-inter */}
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 lg:p-16 text-center max-w-lg w-full">
                <div className="mb-8 flex justify-center">
                    {/* SVG icon representing a "not found" or "broken" state */}
